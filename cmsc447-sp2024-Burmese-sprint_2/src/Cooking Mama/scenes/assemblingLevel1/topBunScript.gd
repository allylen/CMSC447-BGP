...
var speed = 250 # Adjust the falling speed as needed
...
func _ready():
	...
	var random_x = randi_range(-300, 300)
	position.x = random_x
...
func end():
	...
	get_tree().change_scene_to_file("res://scenes/assemblingLevel1/endRound.tscn")

...
@app.route('/get_top_user_scores', methods=['GET'])
...
def get_top_scores():
    ...
    if results:
        leaderboard = {
            "Group": "Burmese",
            "Title": "Top 5 Scores",
            "Scores": [{"name": result[0], "score": result[1], "rank": idx + 1} for idx, result in enumerate(results)]
        }
        return {'success': True, 'leaderboard': leaderboard}, 200
    else:
        return {'success': False, 'message': 'No data found.'}, 404

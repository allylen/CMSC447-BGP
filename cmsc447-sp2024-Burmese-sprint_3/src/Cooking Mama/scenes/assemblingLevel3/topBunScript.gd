...
var speed = 425  # Adjust the falling speed as needed
...
func _ready():
	...
	var random_x = randi_range(-550, 550)
	position.x = random_x
...
func end():
	...
	get_tree().change_scene_to_file("res://scenes/assemblingLevel3/endRound.tscn")

func _on_patty_node_10_area_entered(area):
	collision()
	# round won!
	round_ended = true
	end()
